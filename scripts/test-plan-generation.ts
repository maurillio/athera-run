/**
 * Script de Teste End-to-End - Validação de Dados
 */
...
async function runTest(profile: any, index: number) {
  console.log(`\n${'='.repeat(60)}`);
  ...
  try {
    ...
    console.log(`  ✅ Dias treino: ${(athleteProfile.trainingActivities as number[]).length}`);
