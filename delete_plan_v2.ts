...
async function deletePlan() {
  try {
    ...
    for (const plan of plans) {
      ...
      // Delete weeks first (cascade should handle workouts)
    ...
    console.log('   3. Vá em "Gerar Novo Plano" e complete o onboarding');
    console.log('   4. Verifique logs em Vercel para ver: [WORKOUT ENHANCE]');
